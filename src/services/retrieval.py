...
class ContextService:
    ...
    def get_user_context(self, user_id: str, limit: int = 10) -> UserContextResponse:
        events = self.db.query(EventModel)\
        ...
        if not events:
            return UserContextResponse(user_id=user_id, summary="No events found", user_activity=[])
        ...
        return UserContextResponse(user_id=user_id, summary=summary, user_activity=history)